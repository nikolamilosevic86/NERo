...
class CNN_BLSTM(object):
    ...
    def train(self):
        self.model.fit(self.X_train,self.Y_train,epochs=100,validation_split=0.1,batch_size=64)
    ...
    def createModel(self, text):
        ...
        self.model.add(SeqSelfAttention(attention_activation='sigmoid',attention_width=12))
...
cnblstm.train()
cnblstm.save_model("../Models/DeId/BiLSTM_Glove_de_identification_model_w_attention")
