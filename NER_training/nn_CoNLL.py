...
class CNN_BLSTM(object):
    ...
    def loadData(self):
        ...
        self.trainSentences = readfile("../Datasets/data/train.txt")
        self.devSentences = readfile("../Datasets/data/dev.txt")
        self.testSentences = readfile("../Datasets/data/test.txt")
